...
date: 03 June 2025
categories: posts
tags: ["regression", "generalized-models", "likelihood"]
use_math: true
include_scripts: [
...
<summary>Proof.</summary>
    Under certain regularity conditions, which we'll assume hold here, the expectation of the score function (the gradient of the log-likelihood) should equal zero (see <a href="/posts/2025/02/03/likelihood-theory.html">my likelihood post</a> for a discussion on this). Thus:
    $$
