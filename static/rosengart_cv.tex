...
\textbf{Preprints}
\begin{enumerate}[label= {[\arabic*]}]
\item Omelchenko, A. A., Siwek, J. C., Chhibbar, P., Arshad, S., Nazarali, I., Nazarali, K., {\bf Rosengart, A.}, Rahimikollu, J., Tilstra, J., Shlomchik, M. J., Koes, D. R., Joglekar, A. V., \& Das, J. (2024). Sliding Window INteraction Grammar (SWING): a generalized interaction language model for peptide and protein interactions. {\it bioRxiv : the preprint server for biology}, \doi{10.1101/2024.05.01.592062}.
\end{enumerate}
